...
from src.networks import UNet, R2UNet, AttentionUNet, R2AttentionUNet
import csv
...
class Solver(object):
    ...
    def build_model(self):
        ...
        if self.model_type == 'U_Net':
            ...
            self.unet = AttentionUNet(img_ch=3, output_ch=1)
        elif self.model_type == 'R2AttU_Net':
            self.unet = R2AttentionUNet(img_ch=3, output_ch=1, t=self.t)
