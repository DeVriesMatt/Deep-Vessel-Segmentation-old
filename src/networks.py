...
class UpConv(nn.Module):
    """
    Upsampled convolutional block with batch normalisation and ReLU activation
    """
    def __init__(self, ch_in, ch_out):
...
class RecurrentBlock(nn.Module):
    """
    Recurrent block with batch normalisation and ReLU activation function
    """
...
class SingleConv(nn.Module):
    """
    Single convolutional block with batch normalisation and ReLU activation
    """
    def __init__(self, ch_in, ch_out):
...
class AttentionUNet(nn.Module):
    """
    Attention U-Net: Learning Where to Look for the vessel
    """
    def __init__(self, img_ch=3, output_ch=1):
